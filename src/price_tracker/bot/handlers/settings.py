...
Phase 2 F3.D additions [item 29]: per-user notification preference commands
...
# ── Phase 2 F3.D: notification preference commands ────────────────────
...
def register(app: Application) -> None:
    ...
    # Phase 2 F3.D notification preference commands [item 29]
