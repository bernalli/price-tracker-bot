...
> **Status**: pre-public release (v0.1.0-publish-ready). Badges go live after first GitHub push (Phase 4 milestone).
...
- v0.1.0 — first public release (Phase 4 milestone): GitHub push + ghcr.io image
