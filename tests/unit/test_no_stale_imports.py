...
The monolith split moved everything under ``price_tracker.*`` but
...
# Bare module names that used to live at top-level in the earlier layout.
...
def test_no_top_level_legacy_import_in_src() -> None:
    ...
    assert not offenders, (
        "Stale top-level legacy module import (module-split regression). Use the "
