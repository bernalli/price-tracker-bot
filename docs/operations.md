...
`docker-compose.yml` ships F7 hardening directives (Phase 3 F7 closure). Reference excerpt:
...
Until Phase 4 publishes the GitHub Container Registry image:
...
Once the `ghcr.io/bernalli/price-tracker-bot` image is available (Phase 4 F8 milestone):
